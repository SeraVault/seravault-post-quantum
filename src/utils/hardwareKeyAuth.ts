...
async function encryptWithHardwareKey(
  ...
  // Derive encryption key deterministically from credentialId + userId
  // This allows us to encrypt and decrypt with the same key
  ...
  const encryptionKey = await crypto.subtle.deriveKey(
    {
      name: 'PBKDF2',
      salt: new TextEncoder().encode('SeraVault-HW-Key-V3'),
      iterations: 100000,
      hash: 'SHA-256'
    },
    importedKey,
