    ...
    credit_card: {
      ...
      schema: {
        fields: [
          ...
          { id: 'notes', type: 'richtext', label: 'Notes', placeholder: 'Additional notes with rich formatting...' },
        ],
      },
      defaultData: {},
    ...
    bank_account: {
      ...
      schema: {
        fields: [
          ...
          { id: 'notes', type: 'richtext', label: 'Notes', placeholder: 'Additional banking information with rich formatting...' },
        ],
      },
      defaultData: {},
    ...
    identity: {
      ...
      schema: {
        fields: [
          ...
          { id: 'notes', type: 'richtext', label: 'Notes', placeholder: 'Additional identification details with rich formatting...' },
        ],
      },
      defaultData: {},
    ...
    wifi_network: {
      ...
      schema: {
        fields: [
          ...
          { id: 'notes', type: 'richtext', label: 'Notes', placeholder: 'Network configuration details with rich formatting...' },
        ],
      },
      defaultData: {},
      tags: ['network', 'tech'],
    ...
    crypto_wallet: {
      ...
      schema: {
        fields: [
          ...
          { id: 'notes', type: 'richtext', label: 'Notes', placeholder: 'Wallet configuration and backup information with rich formatting...' },
        ],
      },
      defaultData: {},
      tags: ['crypto', 'wallet'],
    ...
    medical_record: {
      ...
      schema: {
        fields: [
          ...
          { id: 'allergies', type: 'richtext', label: 'Allergies', placeholder: 'Known allergies and reactions with detailed formatting...' },
          { id: 'medications', type: 'richtext', label: 'Current Medications' },
          { id: 'conditions', type: 'richtext', label: 'Medical Conditions', placeholder: 'Chronic conditions, diagnoses with rich formatting...' },
          { id: 'emergency_contact', type: 'text', label: 'Emergency Contact' },
          { id: 'insurance_info', type: 'richtext', label: 'Insurance Information' },
    ...
    legal_document: {
      ...
      schema: {
        fields: [
          ...
          { id: 'party_names', type: 'richtext', label: 'Party Names' },
          ...
          { id: 'notes', type: 'richtext', label: 'Notes', placeholder: 'Legal document details with rich formatting...' },
        ],
      },
      defaultData: {},
    ...
    software_license: {
      ...
      schema: {
        fields: [
          ...
          { id: 'notes', type: 'richtext', label: 'Notes', placeholder: 'Installation instructions, special requirements with rich formatting...' },
        ],
      },
      defaultData: {},
    ...
    insurance_policy: {
      ...
      schema: {
        fields: [
          ...
          { id: 'expiry_date', type: 'date', label: 'Expiry Date' },
          { id: 'agent_info', type: 'richtext', label: 'Agent Information' },
          { id: 'notes', type: 'richtext', label: 'Notes', placeholder: 'Coverage details, exclusions, claims history with rich formatting...' },
        ],
      },
      defaultData: {},
    ...
    vehicle_info: {
      ...
      schema: {
        fields: [
          ...
          { id: 'notes', type: 'richtext', label: 'Notes', placeholder: 'Maintenance records, modifications, accidents with rich formatting...' },
        ],
      },
      defaultData: {},
